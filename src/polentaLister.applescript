...
set cmd_cleanKeywords2 to "sed 's/, /,/g'  " & baseFolderX & "total2.csv >  " & baseFolderX & "total3.csv"
set cmd_cleanKeywords3 to "sed 's/Keywords                        ://g' " & baseFolderX & "total3.csv > " & baseFolderX & "_OUTPUT.csv "
set cmd_cleanupFiles to "rm " & baseFolderX & "keywords-list.txt " & baseFolderX & "odd.csv " & baseFolderX & "even.csv " & baseFolderX & "total.csv " & baseFolderX & "total2.csv " & baseFolderX & "total3.csv"
